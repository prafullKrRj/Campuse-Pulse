package com.prafullkumar.campusepulse.studentApp.attendanceScreen
...
import com.prafullkumar.campusepulse.studentApp.homeScreen.StudentScreenState
...
fun AttendanceBody(viewModel: StudentViewModel, paddingValues: PaddingValues, studentData: Student) {
    ...
    Column(
        ...
        OverallAttendanceSection(heading = stringResource(id = R.string.overall_attendance), chartData = GetChartData.getOverallAttendanceData(getOverallAttendanceData(studentData.attendance!!)))
